...
const ServerSearch: React.FC<ServerSearchProps> = ({ data }) => {
  return (
    <>
      <button className="group p-2 rounded-md flex items-center gap-x-2 w-full transition my-2">
        <svg
        ...
        <p className="font-semibold text-sm text-zinc-400">Browse Channels</p>
      </button>
    </>
  );
};
